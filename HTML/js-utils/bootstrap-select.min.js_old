        ...
        e.VERSION = "1.10.0", e.DEFAULTS = {
            ...
            createDropdown: function() {
                var b = this.multiple || this.options.showTick ? " show-tick" : "",
                    ...
                    g = this.options.liveSearch ? '<div class="bs-searchbox"><i class="icon ion-ios-search"></i><input type="text" class="form-control" autocomplete="off"' + (null === this.options.liveSearchPlaceholder ? "" : ' placeholder="' + c(this.options.liveSearchPlaceholder) + '"') + "></div>" : "",
            ...
            clickListener: function() {
                ...
                this.$newElement.on("touchstart.dropdown", ".dropdown-menu", function(a) {
                    ...
                    var dropwidth = $(this).innerWidth();
                    var selh = $(this).innerHeight();
                    var selw = $(this).innerWidth();
                    var seltp = $(this).offset().top;
                    var sellp = $(this).offset().left;

                    var post = selh + seltp + 2;
                    var posl = sellp;

                    console.log(selh , selw , seltp , sellp , dropwidth);
                    $(this).parents('.bootstrap-select').find('div.dropdown-menu').css({
                        width: dropwidth,
                        top: post,
                        left: posl
                    });
